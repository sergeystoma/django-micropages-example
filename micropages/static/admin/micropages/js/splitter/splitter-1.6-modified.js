/* This is a slightly modified version of original jquery.splitter. 
 * It adds an extra class to panes when splitting dragging is active,
 * allowing to overlay embedded iframes, instead of hidding them.
 */
 ...
 $.fn.splitter = function(args){
	...
	return this.each(function() {
		...
		function startSplitMouse(evt) {
			...
			panes.addClass(opts.splitterActiveClass);
		...
		function endSplitMouse(evt) {
			...
			panes.removeClass(opts.splitterActiveClass);
			$(document)
		...
		var opts = $.extend({
			...
			splitterActiveClass: 'splitter-active'
		},{
			// user can override
